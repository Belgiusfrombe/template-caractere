...
export default {
  ...
  setup() {
    ...
    const { projects, getProjectCount } = storeToRefs(store); // ✅ Ajout du compteur

    return {
      projects,
      getProjectCount, // ✅ Retourne le getter
    };
  },
};
</script>
...
<template>
  <div class="project-page min-h-screen bg-[#0f172a] p-8">
    ...
    <h2 class="text-gray-400 text-lg mb-10">Nombre de projets {{ getProjectCount }} </h2>
