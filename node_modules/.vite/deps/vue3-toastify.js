...
function we(e) {
  var E;
  const { position: t, containerClassName: n, rtl: a = false, style: o = {} } = e, s = r.CSS_NAMESPACE, d = qe(t), v = document.querySelector(`.${s}`), u = document.querySelector(`.${d}`), A = !!u && !((E = u.className) != null && E.includes(K)), m = v || document.createElement("div"), S = document.createElement("div");
  S.className = Be(
    t,
    n,
    a
  ...
  return v || (m.className = r.CSS_NAMESPACE, document.body.appendChild(m)), A || m.appendChild(S), S;
}
function ee(e) {
  var a, o, s;
  ...
  remove(e) {
    if (e) {
      ...
      if (t) {
        ...
        c[t] = n.filter((o) => o.toastId !== e), !c[t].length && !De(t) && te(t, false), xe(), nextTick(() => {
...
var We = defineComponent({
  ...
  setup(e, {
    ...
    })), s = computed(() => [`${r.CSS_NAMESPACE}__progress-bar`, e.controlledProgress ? `${r.CSS_NAMESPACE}__progress-bar--controlled` : `${r.CSS_NAMESPACE}__progress-bar--animated`, `${r.CSS_NAMESPACE}__progress-bar-theme--${e.theme}`, `${r.CSS_NAMESPACE}__progress-bar--${e.type}`, e.rtl ? `${r.CSS_NAMESPACE}__progress-bar--rtl` : null].filter(Boolean).join(" ")), d = computed(() => `${s.value} ${(t == null ? void 0 : t.class) || ""}`), v = () => {
      n.value && (n.value.onanimationend = null, n.value.ontransitionend = null);
    }, u = () => {
      e.isIn && e.closeToast && e.autoClose !== false && (e.closeToast(), v());
    }, A = computed(() => e.controlledProgress ? null : u), m = computed(() => e.controlledProgress ? u : null);
    return watchEffect(() => {
      n.value && (v(), n.value.onanimationend = A.value, n.value.ontransitionend = m.value);
    }), () => createVNode("div", {
      ref: n,
      role: "progressbar",
      "aria-hidden": a.value,
...
function nt({
  ...
  return n ? o = oe.spinner() : a === false ? o = void 0 : G(a) ? o = toRaw(a) : B(a) ? o = a(s) : isVNode(a) ? o = cloneVNode(a, s) : ae(a) || ze(a) ? o = a : tt(t) && (o = oe[t](s)), o;
}
var at = () => {
};
...
function st(e) {
  ...
  }), d = s.done || at, v = computed(() => s.appendPosition ? `${s.enter}--${s.position}` : s.enter), u = computed(() => s.appendPosition ? `${s.exit}--${s.position}` : s.exit), A = computed(() => e.pauseOnHover ? {
    onMouseenter: h2,
    onMouseleave: I
  } : {});
  function m() {
...
var rt = defineComponent({
  ...
  setup(e) {
    ...
    return () => createVNode("div", mergeProps({
      ...
      theme: e.theme,
      type: e.type
    }) : o.value]), e.contentProps ? createVNode("div", {
...
function L(e, t, n = {}) {
  ...
  return a < 0 && (n.progress = 0), a > 1 && (n.progress = 1), n.theme === "auto" && (n.theme = Ve()), dt(n), Q.lastUrl = window.location.href, n.multiple ? N.items.length ? n.updateId && j(e, n) : j(e, n) : (X = true, i.clearAll(void 0, false), setTimeout(() => {
    j(e, n);
  }, 0), setTimeout(() => {
    X = false;
  }, 390)), n.toastId;
